...
<h2>지점 등록하기</h2>
    ...
    <div class="write_div">
        ...
        <input class="frm_input full_input" type="text" name="wr_content" id="wr_content" placeholder="지점 주소를 입력해주세요. 동 호수까지 정확히 입력해주셔야 합니다.">
    </div>

    <div class="write_div">
        <label for="wr_1" class="sound_only">내용<strong>필수</strong></label>
        <input class="frm_input full_input" type="text" name="wr_1" id="wr_1" placeholder="예시 02-334-4122">
    </div>

        ...
        <div class="bo_cnt">
                    <div class="reser_grid">
                        ...
                        <div>
                            ...
                            <option value="<?php echo G5_BBS_URL; ?>/director_update.php?rid=<?php echo $list[$i]['wr_id']; ?>&rcon=<?php echo "대기중"; ?>" <?php if($list[$i]['wr_10']=='대기중') echo 'selected'; ?>>대기중</option>
                                    <option value="<?php echo G5_BBS_URL; ?>/director_update.php?rid=<?php echo $list[$i]['wr_id']; ?>&rcon=<?php echo "예약보류"; ?>" <?php if($list[$i]['wr_10']=='예약보류') echo 'selected'; ?>>예약보류</option>
                                    <option value="<?php echo G5_BBS_URL; ?>/director_update.php?rid=<?php echo $list[$i]['wr_id']; ?>&rcon=<?php echo "예약완료"; ?>" <?php if($list[$i]['wr_10']=='예약완료') echo 'selected'; ?>>예약완료</option>
                                    <option value="<?php echo G5_BBS_URL; ?>/director_update.php?rid=<?php echo $list[$i]['wr_id']; ?>&rcon=<?php echo "부재중"; ?>" <?php if($list[$i]['wr_10']=='부재중') echo 'selected'; ?>>부재중</option>
                                    <option value="<?php echo G5_BBS_URL; ?>/director_update.php?rid=<?php echo $list[$i]['wr_id']; ?>&rcon=<?php echo "확인완료"; ?>" <?php if($list[$i]['wr_10']=='확인완료') echo 'selected'; ?>>확인완료</option>
                            </select>
                        </div></div>
                    </div>
